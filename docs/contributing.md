...
1. Press the Fork button in the upper-right corner of the [NDIcalc-ephys-matlab](https://github.com/VH-Lab/NDIcalc-ephys-matlab/) GitHub repository to make a copy of NDIcalc-ephys-matlab in your own GitHub space.

2. Make your changes to NDIcalc-ephys-matlab.
